...
class GCancerScreen extends StatefulWidget {
  const GCancerScreen({Key? key}) : super(key: key);

  @override
  _GCancerScreenState createState() => _GCancerScreenState();
}

class _GCancerScreenState extends State<GCancerScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchCancerData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/gcancer.php'));
