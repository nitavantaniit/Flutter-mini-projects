...
class GVirgoScreen extends StatefulWidget {
  const GVirgoScreen({Key? key}) : super(key: key);

  @override
  _GVirgoScreenState createState() => _GVirgoScreenState();
}

class _GVirgoScreenState extends State<GVirgoScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchVirgoData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/gvirgo.php'));
