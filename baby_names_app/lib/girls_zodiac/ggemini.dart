...
class GGeminiScreen extends StatefulWidget {
  const GGeminiScreen({Key? key}) : super(key: key);

  @override
  _GGeminiScreenState createState() => _GGeminiScreenState();
}

class _GGeminiScreenState extends State<GGeminiScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchGeminiData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/ggemini.php'));
