...
class BAquariusScreen extends StatefulWidget {
  const BAquariusScreen({Key? key}) : super(key: key);

  @override
  _BAquariusScreenState createState() => _BAquariusScreenState();
}

class _BAquariusScreenState extends State<BAquariusScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchAquariusData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/baquarius.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Aquarius - Boys Names'), 
