...
class BAriesScreen extends StatefulWidget {
  const BAriesScreen({Key? key}) : super(key: key);

  @override
  _BAriesScreenState createState() => _BAriesScreenState();
}

class _BAriesScreenState extends State<BAriesScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchAriesData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/baeries.php'));
