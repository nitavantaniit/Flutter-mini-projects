...
class BTaurusScreen extends StatefulWidget {
  const BTaurusScreen({Key? key}) : super(key: key);

  @override
  _BTaurusScreenState createState() => _BTaurusScreenState();
}

class _BTaurusScreenState extends State<BTaurusScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchTaurusData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/btaurus.php'));
