...
class BCapricornScreen extends StatefulWidget {
  const BCapricornScreen({Key? key}) : super(key: key);

  @override
  _BCapricornScreenState createState() => _BCapricornScreenState();
}

class _BCapricornScreenState extends State<BCapricornScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchCapricornData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/bcapricorn.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Capricorn - Boys Names'),
