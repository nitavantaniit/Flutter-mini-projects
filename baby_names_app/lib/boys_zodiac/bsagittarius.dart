...
class BSagittariusScreen extends StatefulWidget {
  const BSagittariusScreen({Key? key}) : super(key: key);

  @override
  _BSagittariusScreenState createState() => _BSagittariusScreenState();
}

class _BSagittariusScreenState extends State<BSagittariusScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchSagittariusData() async {
    final response = await http.get(
        Uri.parse('https://18septbabynames.000webhostapp.com/bsagittarius.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sagittarius - Boys Names'), 
